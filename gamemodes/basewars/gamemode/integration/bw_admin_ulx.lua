...
function ulx.addmoney(calling_ply, target_plys, amt)
    ...
    ulx.fancyLogAdmin(calling_ply, "#A gave " .. string.format(BaseWars.LANG.CURFORMER, amt) .. " to #T", affected_plys)
end


local addmoney = ulx.command(CATEGORY_NAME, "ulx addmoney", ulx.addmoney, "!addmoney")
	addmoney:addParam{type = ULib.cmds.PlayersArg}
	addmoney:addParam{type = ULib.cmds.NumArg, min = 0, max = 10^100, hint = "Money", ULib.cmds.round}
...
function ulx.takemoney(calling_ply, target_plys, amt)
    ...
    ulx.fancyLogAdmin(calling_ply, "#A took " .. string.format(BaseWars.LANG.CURFORMER, amt) .. " from #T", affected_plys)
end
...
local takemoney = ulx.command(CATEGORY_NAME, "ulx takemoney", ulx.takemoney, "!takemoney")
	...
	takemoney:addParam{type = ULib.cmds.NumArg, min = 0, max = 10^100, hint = "Money", ULib.cmds.round}
...
function ulx.setmoney(calling_ply, target_plys, amt)
    ...
    ulx.fancyLogAdmin(calling_ply, "#A set #T's money to " .. string.format(BaseWars.LANG.CURFORMER, amt), affected_plys)
end

local setmoney = ulx.command(CATEGORY_NAME, "ulx setmoney", ulx.setmoney, "!setmoney")
	setmoney:addParam{type = ULib.cmds.PlayersArg}
	setmoney:addParam{type = ULib.cmds.NumArg, min = 0, max = 10^100, hint = "Money", ULib.cmds.round}
...
function ulx.addlevel(calling_ply, target_plys, amt)
    ...
    ulx.fancyLogAdmin(calling_ply, "#A added " .. amt .. " to #T's level", affected_plys)
end
...
function ulx.setlevel(calling_ply, target_plys, amt)
    ...
    ulx.fancyLogAdmin(calling_ply, "#A set #T's level to " .. amt, affected_plys)
end
...
function ulx.addxp(calling_ply, target_plys, amt)
    ...
    ulx.fancyLogAdmin(calling_ply, "#A added " .. amt .. " to #T's XP", affected_plys)
end
...
function ulx.setxp(calling_ply, target_plys, amt)
    ...
    ulx.fancyLogAdmin(calling_ply, "#A set #T's XP to " .. amt, affected_plys)
end
...
function ulx.addkarma(calling_ply, target_plys, amt)
    ...
    ulx.fancyLogAdmin(calling_ply, "#A added " .. amt .. " to #T's karma", affected_plys)
end
...
function ulx.setkarma(calling_ply, target_plys, amt)
    ...
    ulx.fancyLogAdmin(calling_ply, "#A set #T's karma to " .. amt, affected_plys)
end
